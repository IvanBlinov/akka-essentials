...
object Mailboxes extends App {
  ...
  supportTicketLogger ! "[P0] this thing need to be solved NOW!"
  supportTicketLogger ! "[P1] do this when you have time"

  /**
    * Interesting case #2 - control-aware mailbox
    * we'll user UnboundedControlAwareMailbox
    */
  ...
  controlAwareActor ! "[P0] this thing need to be solved NOW!"
  ...
  altControlAwareActor ! "[P0] this thing need to be solved NOW!"
